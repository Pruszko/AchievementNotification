...
from achievementnotification.settings import getDefaultConfigTokens, ConfigException
...
from achievementnotification.settings.migrations import performConfigMigrations
from achievementnotification.utils import *
...
class Config(object):
    ...
    def __init__(self):
        ...
        self.onConfigReload = Event.Event()
    ...
    def __updateModSettingsApiIfPresent():
        ...
        if g_achievementNotificationMod.isModsSettingsApiPresent:
            from achievementnotification.support.mods_settings_api_support import onConfigFileReload
            from achievementnotification.support.mods_settings_api_support import settingsChangedSemaphore
