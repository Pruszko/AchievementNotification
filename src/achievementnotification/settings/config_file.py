...
from achievementnotification.settings import createFolderSafely, getDefaultConfigTokens, ConfigException
from achievementnotification.settings.config_template import CONFIG_TEMPLATE
from achievementnotification.utils import createLogger

logger = createLogger(__name__)


CONFIG_FILE_DIR = os.path.join("mods", "configs", "AchievementNotification")
